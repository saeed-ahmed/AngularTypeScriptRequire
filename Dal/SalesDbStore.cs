...
namespace Dal
{
    public class SalesDbStore
    {
        ...
        public List<Sales> GetAllSales()
        {
            ...
            {
                salesList.Add(new Sales { Id = 1, Site = "Head Office", Status = "Paid", Summary = "ePOS POS", Type = "POS", Value = 10 });
                salesList.Add(new Sales { Id = 2, Site = "Head Office", Status = "Unpaid", Summary = "ePOS POS", Type = "POS", Value = 210 });
